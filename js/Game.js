class Game {
  ...
  //update the gameState to database
  updateState(state){
    database.ref("/").update({
      gameState : state
    })
  ...
  start() {
    ...
    this.addSprites(obscacles, obstaclesPositions.length, obstacle1Image,0.04,obstaclesPositions )
  }
  ...
  handleObstacleCollision(index){
    if(cars[index-1].collide(obscacles)){
  ...
  addSprites(spritGroup, numSprites, spriteImg, scale,positions = []){
